...
public class BbsController {
	 ...
	 * //dao를 이용해서 여러개를 받아서 가지고 와주세요. List<BbsDTO> list = dao.list();
	 * System.out.println(list.size()); //views/list.jsp까지 넘어가야 함.==>Model //model을
	 * 이용해서 검색결과인 list를 list.jsp까지 넘기자.! model.addAttribute("list", list); }
	 */
	
	// 요청하나당 함수하나.
	@RequestMapping("insert2")
	public void insert2(BbsVO bag, Model model) {
